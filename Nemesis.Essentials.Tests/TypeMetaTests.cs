...
public class TypeMetaTests
{
    ...
    public void ConstructorOfTest()
    {
        ...
        Assert.Multiple(() =>
        {
            ...
            Assert.That(ctorForSampleClass, Is.EqualTo(typeof(CtorClass).GetConstructor(new[] { typeof(int) })));
    ...
    public void PropertyOfTest()
    {
        ...
        Assert.Multiple(() =>
        {
            Assert.That(prop, Is.EqualTo(typeof(PropFieldClass).GetProperty(nameof(PropFieldClass.Prop))));
            Assert.That(autoProp, Is.EqualTo(typeof(PropFieldClass).GetProperty(nameof(PropFieldClass.AutoProp))));
            Assert.That(staticProp, Is.EqualTo(typeof(PropFieldClass).GetProperty(nameof(PropFieldClass.StaticProp))));
            Assert.That(stringLength, Is.EqualTo(typeof(string).GetProperty(nameof(string.Length))));
            Assert.That(secondLevel, Is.EqualTo(typeof(string).GetProperty(nameof(string.Length))));
    ...
    public void FieldOfTest()
    {
        ...
        Assert.That(field, Is.EqualTo(typeof(PropFieldClass).GetField(nameof(PropFieldClass.NormalField))));
        Assert.That(readOnlyField, Is.EqualTo(typeof(PropFieldClass).GetField(nameof(PropFieldClass.ReadOnlyField))));
        Assert.That(staticField, Is.EqualTo(typeof(PropFieldClass).GetField(nameof(PropFieldClass.StaticField))));
        Assert.That(stringEmpty, Is.EqualTo(typeof(string).GetField(nameof(string.Empty))));
        Assert.Multiple(() =>
        {
    ...
    public void IndexerOfTest()
    {
        ...
        Assert.That(index1Value, Is.EqualTo(30));
        Assert.That(index2Value, Is.EqualTo("300XXX"));
...
#pragma warning restore IDE0032 // Use auto property
    ...
    private static IEnumerable<TCD> GetFriendlyNameData() => new[]
    {
    ...
    private readonly struct MyStruct<T>
    {
        public T Value { get; }
    }
