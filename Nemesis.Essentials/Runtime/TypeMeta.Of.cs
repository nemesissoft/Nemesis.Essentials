    ...
    static class Method
    {
        ...
        public static MethodInfo OfExpression<TDelegate>(Expression<TDelegate> expression) =>
            expression.Body is MethodCallExpression call
                ? call.Method
                : throw new NotSupportedException("Only method calls are valid at this point");
    }
    ...
    public static class Event
    {
        public static EventInfo? Of<TType>(Expression<Func<TType, Delegate>> @event) =>
            ...
            body.Member is FieldInfo eventField
                ...
                : throw new ArgumentException("Only member (event) expressions are valid at this point", nameof(@event));
    }

    public static class Ctor
    {
        public static ConstructorInfo? Of<TType>(Expression<Func<TType>> constructor) =>
            constructor.Body is NewExpression ctor ? ctor.Constructor : throw new ArgumentException("Only constructor expressions are valid at this point", nameof(constructor));
        ...
        public static Func<TType> FactoryOf<TType>(Expression<Func<TType>> constructor, params object[] ctorArguments)
        {
            ...
            ParameterInfo[] ctorParamsInfos = ctor.GetParameters();
            if (ctorParamsInfos.Length != ctorArguments.Length)
