...
public static class ExpressionUtils
{
    ...
    {
        var containsMethod = Method.Of<Func<string, bool>>("".Contains);
        var startsWithMethod = Method.Of<Func<string, bool>>("".StartsWith);
        var endsWithMethod = Method.Of<Func<string, bool>>("".EndsWith);
        ...
        else exp = endsWith ? Expression.Call(member, startsWithMethod, constant) : Expression.Equal(member, constant);
